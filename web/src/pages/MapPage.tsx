  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 animate-fade-in-up">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[var(--color-text-primary)]">地图定位</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <div className="absolute top-4 right-4 flex flex-col gap-2">
              <button
                ...
                className="p-3 bg-white rounded-xl shadow-md hover:bg-[var(--color-bg-tertiary)] transition-colors btn-press"
              >
            ...
            {currentLocation ? (
              <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-md">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-[var(--color-primary-bg)] rounded-full flex items-center justify-center">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-[var(--color-border)]">
            <h3 className="text-sm font-semibold text-[var(--color-text-primary)] mb-3">选择设备</h3>
          ...
          {/* 轨迹查询 */}
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-[var(--color-border)]">
            <h3 className="text-sm font-semibold text-[var(--color-text-primary)] mb-3">历史轨迹</h3>
            <button
              onClick={handleShowTrack}
              disabled={!selectedDeviceImei}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[var(--color-primary)] text-white rounded-xl font-medium text-sm hover:opacity-90 transition-colors disabled:opacity-50 btn-press"
            >
          ...
          {/* 图例 */}
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-[var(--color-border)]">
            <h3 className="text-sm font-semibold text-[var(--color-text-primary)] mb-3">图例</h3>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <span className="w-4 h-4 bg-[var(--color-primary)] rounded-full" />
                <span className="text-xs text-[var(--color-text-secondary)]">设备位置</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-8 h-0.5 bg-[var(--color-primary)] rounded" />
                <span className="text-xs text-[var(--color-text-secondary)]">移动轨迹</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-4 h-4 border-2 border-dashed border-[var(--color-primary)]/40 rounded-full" />
                <span className="text-xs text-[var(--color-text-secondary)]">定位精度</span>
              </div>
            </div>
          </div>
        </div>
