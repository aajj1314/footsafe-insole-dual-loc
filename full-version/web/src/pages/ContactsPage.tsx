      ...
      <section aria-label="联系人列表">
        {isLoading ? (
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-[var(--color-border)] text-center">
            <User className="w-12 h-12 mx-auto mb-4 text-[var(--color-text-muted)] opacity-50" aria-hidden="true" />
    ...
    >
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md animate-fade-in-up">
        ...
        <header className="p-6 border-b border-[var(--color-border)] flex items-center justify-between">
          <h3 id="contact-modal-title" className="text-lg font-bold text-[var(--color-text-primary)]">
            {contact ? '编辑联系人' : '添加联系人'}
          </h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-4">
            ...
            {error && (
              <div
                className="flex items-center gap-2 p-3 bg-[var(--color-danger-bg)] rounded-xl text-sm text-[var(--color-danger)]"
                role="alert"
              >
            ...
            {/* 电话 */}
            <div>
              <label htmlFor="contact-phone" className="block text-sm font-medium text-[var(--color-text-secondary)] mb-2">
                电话 *
              </label>
              <input
                id="contact-phone"
            ...
            {/* 关系 */}
            <div>
              <label htmlFor="contact-relation" className="block text-sm font-medium text-[var(--color-text-secondary)] mb-2">
                关系
              </label>
              <input
                id="contact-relation"
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] ${
